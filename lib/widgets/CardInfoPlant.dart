...
class _CardInfoPlantState extends State<CardInfoPlant> {
  ...
  var colors = [Color(0xFFEFAD06),Color(0xFF46BFE3),Color(0xFF0707BB),Color(
      0xFF8D897C)];
      ...
      child: Card(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text(valuesMocked[type], style: TextStyle(fontSize: 24, color: fontColor)),
              Text(labels[type], style: TextStyle(fontSize: 24, color: fontColor)),
            ],
          ),
        ),
        color: colors[type],
